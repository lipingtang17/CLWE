    ...
    def dist_mean_cosine(self, to_log, src_to_tgt):
        ...
        if src_to_tgt: 
            ...
            for dico_method in ['csls_knn_10']:
                ...
                to_log['number_words_in_dict-%s' % (_params.dico_build)] = dico.size(0)
                to_log['number_words_in_dict*cos-%s' % (_params.dico_build)] = dico.size(0)*mean_cosine
            ...
            for dico_method in ['csls_knn_10']:
                ...
                to_log['number_words_in_dict-T2S'] = dico.size(0)
                to_log['number_words_in_dict*cos-T2S'] = dico.size(0)*mean_cosine
