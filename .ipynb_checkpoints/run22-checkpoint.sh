...
exp_name_en='MUSE/ar_007_en'
exp_name_z='MUSE/ar_007'
tgt_lang='ar'
mapping_dir="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/MUSE/en_ar/007"
exp_id=007

# ## generate the best mapping after procrustes
# CUDA_VISIBLE_DEVICES=3 python Other_models/MUSE/unsupervised.py \
# --n_epochs 0 \
# --n_refinement 1 \
# --src_lang en \
# --tgt_lang $tgt_lang \
