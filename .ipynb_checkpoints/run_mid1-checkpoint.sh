...
exp_name_en='proc/hi_mid003_l_en'
exp_name_z='proc/hi_mid003_l'
tgt_lang='hi'
mapping_dir="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/unsup_formal/mid/en_hi/003"
exp_id=003

## generate the best mapping after procrustes
CUDA_VISIBLE_DEVICES=5 python unsupervised.py \
--src_lang en \
--tgt_lang $tgt_lang \
...
exp_name_en='proc/hi_mid103_l_en'
exp_name_z='proc/hi_mid103_l'
tgt_lang='hi'
mapping_dir="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/unsup_formal/mid/en_hi/103"
exp_id=103
