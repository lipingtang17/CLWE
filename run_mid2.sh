...
exp_name_en='proc/bg_mid102_l_en'
exp_name_z='proc/bg_mid102_l'
tgt_lang='bg'
mapping_dir="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/unsup_formal/mid/en_bg/102"
exp_id=102

## generate the best mapping after procrustes
CUDA_VISIBLE_DEVICES=6 python unsupervised.py \
--src_lang en \
--tgt_lang $tgt_lang \
...
exp_name_en='proc/bg_mid104_l_en'
exp_name_z='proc/bg_mid104_l'
tgt_lang='bg'
mapping_dir="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/unsup_formal/mid/en_bg/104"
exp_id=104
