...
declare -a tgt_lang_list=(tr fr ru de es ar ar ar)
declare -a exp_id_llist=(001 001 002 002 001 002 003 004)
...
output_file="/users/cpii.local/lptang/NLP_models/CLWE_formal/output/original_results_origf.txt"
