...
def main(test_file, pretrained_file, batch_size=32, embeddings_file=None):
    """
...
if __name__ == "__main__":
 ...
 some dataset")
    parser.add_argument("--test_data", default="../../data/preprocessed/SNLI/test_data.pkl",
                        help="Path to a file containing preprocessed test data")
    parser.add_argument("--checkpoint", default="../../data/checkpoints/SNLI/best.pth.tar",
