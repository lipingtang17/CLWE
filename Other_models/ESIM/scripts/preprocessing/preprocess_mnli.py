...
def preprocess_MNLI_data(inputdir,
    ...
    preprocessor = Preprocessor(mapping_dir=mapping_dir,
                                lowercase=lowercase,
    ...
    # import ipdb
    # ipdb.set_trace()
    # tmp_path = os.path.join(inputdir, train_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--embeddings_file",
                        default="/mnt/ssd-201-112-01/cpii.local/lptang/WordEmb/fasttext/wiki.en.vec",
                        help="Path to a configuration file for preprocessing MultiNLI")
