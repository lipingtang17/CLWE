...
def main(train_file,
    ...
    """
    device = device or (torch.device("cuda:7" if torch.cuda.is_available() else "cpu"))
    # device = "cpu"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--embeddings",
                        default="../../data/preprocessed/MNLI/embeddings.pkl",
                        help="Path to a checkpoint file to resume training")
    parser.add_argument("--target_dir",
                        default="../../data/checkpoints/MNLI_fixed",
                        help="Path to a checkpoint file to resume training")
    parser.add_argument("--device",
                        default="cuda:7",
                        help="Path to a checkpoint file to resume training")
    parser.add_argument("--train_file",
                        default="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/ESIM/data/preprocessed/MNLI/train_data.pkl",
                        help="Path to a checkpoint file to resume training")
    parser.add_argument("--valid_file_matched",
                        default="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/ESIM/data/preprocessed/MNLI/matched_dev_data.pkl",
                        help="Path to a checkpoint file to resume training")
    parser.add_argument("--valid_file_mismatched",
                        default="/mnt/ssd-201-112-01/cpii.local/lptang/checkpoints/CLWE/ESIM/data/preprocessed/MNLI/mismatched_dev_data.pkl",
                        help="Path to a checkpoint file to resume training")
    ...
    main(args.train_file,
         {"matched": args.valid_file_matched, "mismatched": args.valid_file_mismatched},
         # os.path.normpath(os.path.join(script_dir, config["embeddings"])),
         # os.path.normpath(os.path.join(script_dir, config["target_dir"])),
         os.path.normpath(os.path.join(script_dir, args.embeddings)),
