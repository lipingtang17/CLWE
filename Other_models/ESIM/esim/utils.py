...
def sort_by_seq_lens(batch, sequences_lengths, descending=True):
    ...
    idx_range =\
        sequences_lengths.new_tensor(torch.arange(0, len(sequences_lengths))).to(device=sequences_lengths.device)
    # idx_range = torch.arange(0, len(sequences_lengths)).clone().detach()
    _, reverse_mapping = sorting_index.sort(0, descending=False)
    # reverse_mapping.to(device=sequences_lengths.device)
    # print(batch.device)
    # print(sequences_lengths.device)
    # print(idx_range.device)
    # print(reverse_mapping.device)
