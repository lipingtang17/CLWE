...
class ESIM(nn.Module):
    ...
    def forward(self,
        ...
        # print("self._word_embedding.weight:", self._word_embedding.weight)
        # print("self._word_embedding.shape:", self._word_embedding.weight.data.shape)
        # print("embedded_premises.shape: ", embedded_premises.shape)
        # print("embedded_hypotheses.shape: ", embedded_hypotheses.shape)
        ...
        # print("enhanced_premises: ", enhanced_premises)
        # print("enhanced_hypotheses: ", enhanced_hypotheses)
        ...
        # print("v_ai: ", v_ai)
        # print("v_bj: ", v_bj)
        # print("projected_premises: ", projected_premises)
        # print("projected_hypotheses: ", projected_hypotheses)
        # print("premises_mask: ", premises_mask)
        # print("hypothese_mask: ", hypotheses_mask)
        # print("hypothesis: ", hypotheses)
        # print("hypo_len: ", hypotheses_lengths)
        # print("premises: ", premises)
        # print("pre_len: ", premises_lengths)
